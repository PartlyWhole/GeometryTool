...
export const PROOFS: ProofProblem[] = [
  {
    ...
    prompt:
      "The arcs mark ∠WVX ≅ ∠YVZ, and ∠XVY lies between them, belonging to both. Prove that m∠WVY = m∠XVZ.",
    figure: fan(),
  ...
  },
  {
    ...
    prompt: "Ray VD bisects ∠AVC. Prove that 2 m∠AVD = m∠AVC.",
    figure: bisector(),
    givens: [{ k: "bisects", by: ray("V", "D"), of: ang("AVC") }],
    goal: { k: "eq", l: mul(num(2), m("AVD")), r: m("AVC") },
    hints: [
  ...
  },
  {
    ...
    prompt:
      "∠1 and ∠2 are a linear pair, so they are supplementary. m∠1 = 16x − 7, m∠2 = 21x + 2, and the arcs mark ∠1 ≅ ∠3. Prove that m∠3 = 73.",
    figure: suppAndCongruent(),
    givens: [
      { k: "supp", a: ang("1"), b: ang("2") },
      { k: "eq", l: m("1"), r: add(mul(num(16), vr("x")), num(-7)) },
      { k: "eq", l: m("2"), r: add(mul(num(21), vr("x")), num(2)) },
      { k: "cong", l: ang("1"), r: ang("3") },
    ],
    goal: { k: "eq", l: m("3"), r: num(73) },
    hints: [
    ...
    tags: ["Form A, Q10", "§10"],
    solution: [
      { statement: { k: "supp", a: ang("1"), b: ang("2") }, reasonId: "given", cites: [] },
      { statement: { k: "eq", l: m("1"), r: add(mul(num(16), vr("x")), num(-7)) }, reasonId: "given", cites: [] },
      { statement: { k: "eq", l: m("2"), r: add(mul(num(21), vr("x")), num(2)) }, reasonId: "given", cites: [] },
      { statement: { k: "cong", l: ang("1"), r: ang("3") }, reasonId: "given", cites: [] },
      { statement: { k: "eq", l: add(m("1"), m("2")), r: num(180) }, reasonId: "def-supplementary", cites: [1] },
      ...
      { statement: { k: "eq", l: m("1"), r: num(73) }, reasonId: "substitution", cites: [2, 9] },
      { statement: { k: "eq", l: m("1"), r: m("3") }, reasonId: "def-cong-ang", cites: [4] },
      { statement: { k: "eq", l: m("3"), r: num(73) }, reasonId: "substitution", cites: [10, 11] },
    ],
  },
  {
    ...
    prompt:
      "A, B, C and D lie in a row, with AB ≅ BC and BC ≅ CD. Prove that AB ≅ CD.",
    figure: fourInARow(),
    givens: [
    ...
    solution: [
      ...
      { statement: { k: "cong", l: seg("B", "C"), r: seg("C", "D") }, reasonId: "given", cites: [] },
      { statement: { k: "cong", l: seg("A", "B"), r: seg("C", "D") }, reasonId: "transitive", cites: [1, 2] },
    ],
  },
  {
    id: "halves-of-whole",
